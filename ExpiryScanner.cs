...
public static class ExpiryScanner
{
    ...
    private static readonly (string[] Keys, string Kind)[] Kinds =
    {
        ...
        (new[] { "travel insurance", "asigurare de călătorie", "asigurare calatorie" }, "Travel insurance"),
        (new[] { "life insurance", "asigurare de viață", "asigurare viata" }, "Life insurance"),
        (new[] { "health insurance", "medical insurance", "dental insurance", "asigurare medicală", "asigurare medicala", "asigurare de sănătate" }, "Health insurance"),
        ...
        (new[] { "mortgage", "credit ipotecar", "ipotecă", "ipoteca" }, "Mortgage"),
        (new[] { "tv licence", "tv license" }, "TV licence"),
        (new[] { "council tax", "impozit local", "impozit pe locuință" }, "Council tax"),
        (new[] { "boiler service", "gas safety", "hvac", "service centrală", "service centrala", "revizie centrală" }, "Boiler service"),
        (new[] { "gym membership", "abonament sală", "abonament sala" }, "Gym membership"),
        (new[] { "subscription", "membership", "abonament", "renewal", "reînnoire", "reinnoire" }, "Subscription"),
        (new[] { "domain", "hosting", "ssl certificate", "ssl" }, "Domain/hosting"),
        (new[] { "warranty", "guarantee", "garanție", "garantie" }, "Warranty"),
        (new[] { "insurance", "asigurare", "asigurarea", "poliță", "polita" }, "Insurance"),
