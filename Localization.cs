...
internal static class L
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> T = new()
    {
        ["en"] = new()
        {
            ...
            ["nav_reminders"] = "Reminders", ["nav_memories"] = "Memories", ["nav_history"] = "History", ["nav_search"] = "Search", ["nav_duplicates"] = "Duplicates",
            ["dup_hint"] = "Find byte-identical duplicate files and clear them safely (to the Recycle Bin).",
        ...
        ["ro"] = new()
        {
            ...
            ["nav_reminders"] = "Reminder-e", ["nav_memories"] = "Amintiri", ["nav_history"] = "Istoric", ["nav_search"] = "Căutare", ["nav_duplicates"] = "Duplicate",
            ["dup_hint"] = "Găsește fișiere duplicate identice și le curăță în siguranță (în Coșul de reciclare).",
