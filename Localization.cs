...
internal static class L
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> T = new()
    {
        ["en"] = new()
        {
            ...
            ["startup"] = "Start with Windows", ["poll"] = "Check every (sec):", ["minage"] = "Min file age (sec):",
            ...
            ["m_open"] = "Open sorted folder", ["m_history"] = "History…", ["m_help"] = "Help", ["m_quit"] = "Quit",
        ...
        ["ro"] = new()
        {
            ...
            ["startup"] = "Pornește cu Windows", ["poll"] = "Verifică la (sec):", ["minage"] = "Vârsta minimă a fișierului (sec):",
            ...
            ["m_open"] = "Deschide folderul sortat", ["m_history"] = "Istoric…", ["m_help"] = "Ajutor", ["m_quit"] = "Ieșire",
